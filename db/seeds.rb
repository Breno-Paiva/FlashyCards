...
Subject.create!(name: "Fine Arts")


Deck.create!(name: "70s", subject_id: Subject.find_by_name("Music History").id)
Deck.create!(name: "80s", subject_id: Subject.find_by_name("Music History").id)
Deck.create!(name: "90s", subject_id: Subject.find_by_name("Music History").id)
