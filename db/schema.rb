...
ActiveRecord::Schema.define(version: 20170601145436) do
  ...
  create_table "subscriptions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["subject_id"], name: "index_subscriptions_on_subject_id", using: :btree
    t.index ["user_id", "subject_id"], name: "index_subscriptions_on_user_id_and_subject_id", unique: true, using: :btree
